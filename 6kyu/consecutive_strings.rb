...
def longest_consec(strarr, k)
  # your code
  # strarr est un array de string
  # chaque string: strarr[n]
  # il faut concaténer par k les strings
  # quand tous les strings sont concaténés
  # il faut retourner la concaténation la plus longue
